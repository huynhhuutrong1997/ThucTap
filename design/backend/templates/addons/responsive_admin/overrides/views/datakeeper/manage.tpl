            ...
            <div class="table-responsive-wrapper">
                <table class="table table-middle table-responsive">
                    ...
                    {foreach from=$backup_files item=file key=name}
                        <tr>
                            <td><input type="checkbox" name="backup_files[]" value="{$name}" class="checkbox cm-item mobile-hide"/>
                            </td>
                            <td data-th="{__("filename")}"><a href="{"datakeeper.getfile?file=`$name`"|fn_url}"><span>{$name}</span></a></td>
