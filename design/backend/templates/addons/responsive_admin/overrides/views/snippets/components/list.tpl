...
{capture name="toolbar"}
    {include file="addons/responsive_admin/overrides/views/snippets/components/adv_buttons.tpl" result_ids=$result_ids return_url=$return_url type=$type addon=$addon|default:""}
{/capture}
