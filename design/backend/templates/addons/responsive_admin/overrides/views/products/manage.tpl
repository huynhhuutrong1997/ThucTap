...
<div class="table-responsive-wrapper">
    ...
    <tr class="cm-row-status-{$product.status|lower} {$hide_inputs_if_shared_product}" data-ca-longtap-action="setCheckBox" data-ca-longtap-target="input.cm-item">
...
{include file="addons/responsive_admin/components/easter_egg.tpl"}
