{capture name="mainbox"}
    <form action="{""|fn_url}" method="post" name="edit_order_invoice_form" class="form-horizontal form-edit">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input id="elm_subject" type="text" name="invoice[subject]" value="{__("responsive_admin.email_order_invoice_subject", ["[company_name]" => $company_data.company_name, "[order_id]" => $order_info.order_id])}" class="span9">
            </div>
        </div>
...
{include file="common/mainbox.tpl"
    title_start=__('responsive_admin.editing_order_invoice')
