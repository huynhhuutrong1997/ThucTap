...
{script src="js/addons/responsive_admin/long_tap.plugin.js"}
{script src="js/addons/responsive_admin/long_tap_multiple_selection.js"}
{script src="js/addons/responsive_admin/responsive_classes.js"}
