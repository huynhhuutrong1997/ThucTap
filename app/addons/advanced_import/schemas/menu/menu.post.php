...
if (isset($schema['top']['administration']['items']['import_data']['subitems']['products'])) {
    $schema['top']['administration']['items']['import_data']['subitems']['advanced_import.advanced_products_import'] = array(
        ...
        'position' => $schema['top']['administration']['items']['import_data']['subitems']['products']['position'] + 10,
