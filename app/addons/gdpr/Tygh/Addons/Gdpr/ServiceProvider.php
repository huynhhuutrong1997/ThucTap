...
class ServiceProvider implements ServiceProviderInterface
{
    ...
    public function register(Container $app)
    {
        ...
        $app['addons.gdpr.service'] = function (Container $app) {
            $addon_settings = (array) Registry::get('settings.gdpr');
            $addon_settings['gdpr']['gdpr_settings_data'] = isset($addon_settings['gdpr']['gdpr_settings_data']) ? json_decode($addon_settings['gdpr']['gdpr_settings_data'], true) : array();
