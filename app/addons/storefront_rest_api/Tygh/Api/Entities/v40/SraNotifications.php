...
class SraNotifications extends ASraEntity
{
    ...
    public function privilegesCustomer()
    {
        ...
        $privileges = array(
            'create' => !empty($this->auth['is_token_auth']),
            'delete' => !empty($this->auth['is_token_auth']),
        );
    ...
    {
        return fn_mobile_app_update_notification_subscribtion(
            $this->auth['user_id'],
            $params['device_id'],
            $params['platform'],
            $params['locale'],
    ...
    {
        return fn_mobile_app_remove_notification_subscribtions(array(
